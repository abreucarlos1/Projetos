...
procedure TTicTac.inicializa; // zera os botões
          begin
               jogos:=jogos+1;
...
procedure TTicTac.mensagem1; // mostra opção de saida caso não haja ganhadores
begin
...
procedure TTicTac.tecla; // verifica tecla já pressionada
begin
